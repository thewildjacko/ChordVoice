...
//        print(masterKeyboard.startingPitch)
        ...
        addKeyboard(initialKey: 9, startingOctave: 4, numberOfKeys: 15, highlightLockKey: -1)
...
//        keyboards[1...].forEach {addChordGestureRecognizers(myKeyboard: $0)}
        keyboards[1...].forEach {addTapGestureRecognizers(myKeyboard: $0)}
    }
...
//        print(masterKeyboard.myKeyboardWidthMod)
        // bottom keyboard
